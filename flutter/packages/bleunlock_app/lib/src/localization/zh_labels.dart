...
const Map<String, String> _exactLabels = {
  ...
  'connecting': '连接中',
  'connected': '已连接',
  'missing shared secret': '缺少共享密钥',
  'missing server host': '缺少 Server 地址',
  'configured': '已配置',
  'missing': '缺失',
  'Close': '靠近',
  'Away': '远离',
  ...
  'Lock sync settings updated': '锁屏同步设置已更新',
  'Lock sync restarted': '锁屏同步已重启',
  'Lock sync status changed': '锁屏同步状态已变化',
  'Lock sync server listening': '锁屏同步 Server 已监听',
  'Lock sync server start failed': '锁屏同步 Server 启动失败',
  'Lock sync server connected': '已连接锁屏同步 Server',
  'Lock sync client connected': '锁屏同步 Client 已连接',
  'Lock sync client connect failed': '锁屏同步 Client 连接失败',
  'Lock sync client socket failed': '锁屏同步 Client 连接异常',
  'Lock sync client upgrade failed': '锁屏同步 Client 升级失败',
